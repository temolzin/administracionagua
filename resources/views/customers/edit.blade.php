                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control shadow-sm" id="hasWaterDayNightUpdate" name="hasWaterDayNightUpdate" placeholder="Ejemplo: Día sí, noche no" value="{{ $customer->has_water_day_night }}" >
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
